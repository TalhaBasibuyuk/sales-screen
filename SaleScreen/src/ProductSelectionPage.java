...
public class ProductSelectionPage extends JPanel {
    ...
    public ProductSelectionPage(CardLayout cardLayout, JPanel parentPanel, CustomerInfoPage customerInfoPage) {
        ...
        priceLabel.setBorder(new EmptyBorder(15, 0, 15, 0));
        ...
        exchangeRateLabel.setForeground(new Color(100, 100, 100));
        gbc.gridy++;
        ...
        confirmPurchaseButton.setBorder(BorderFactory.createEmptyBorder(10, 20, 10, 20));
    ...
    private JPanel createLabeledPanel(String labelText, JComboBox<String> comboBox) {
        ...
        comboBoxPanel.setPreferredSize(new Dimension(250, 30));
